...
async def _(event):
    ...
    if "image" in contentType:
        ...
        await event.edit("Removed image's Background in {} seconds, powered by @cageherosupportt".format(ms))
    else:
        await event.edit("ReMove.BG API returned Errors. Please report to @cageherosupport\n`{}".format(output_file_name.content.decode("UTF-8")))
