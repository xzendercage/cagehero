...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "**No name set yet nibba, check pinned message in** @cageherosupport"
USER_BOT_WARN_ZERO = "`You were spamming my peru master's inbox, henceforth your retarded lame ass has been blocked by my master's userbot.` **Now GTFO, i'm With Mah Bitch** "
USER_BOT_NO_WARN = ("[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](tg://user?id=898096089)\n\n"
                    "`Hello, this is CAGE AI Security Service.You have found your way here to my master,`"
                    f"{DEFAULTUSER}'s` inbox.\n\n"
                    "Leave your name, phone number, address and 1000rs and hopefully you'll get a reply within 2  years.`\n\n"
